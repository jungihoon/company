...
## 👨‍🏫 프로젝트 소개
기업 페이지 중 노후화 되거나 표준화에 맞지않는 사이트를 찾아 W3C, SEO, 웹표준에 맞게 개편하며 사용자화를 위하여 마이크로 인터렉션을 추가하여 개편하는 목표가 있는 프로젝트입니다.

## ⏲️ 개발 기간 
- 2024.09.23(월) ~ 2024.11.30(토)
- HTML 시멘틱 웹, W3C 웹표준의 이해 및 JS기초 특강
- 기존 페이지에 노후화 된 점 구체적인 리스트업 (정확한 개편방향을 위해)
- 개편 방향성 노트 작성 
- 메인의 레이아웃 방향성 리서치, 레퍼런스 및 벤치마킹
- 메인 페이지 피그마 레이아웃 작성
- 구체적인 마이크로 인터렉션 및 모션에 대한 논의
- 서브 페이지의 공통 레이아웃 작업
- 발표
- 부족한 부분의 디벨롭 진행
