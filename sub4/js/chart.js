...
!(function (t, e) {
  ...
  function qt(t, e, i, s) {
    ...
    for (l = 0; l < r; l++)
      ...
      else if (Y(d)) for (h = 0, c = d.length; h < c; h++) (u = d[h]), null == u || Y(u) || (a = Xt(t, n, o, a, u));
    t.restore();
    const f = o.length / 2;
    if (f > i.length) {
  ...
  function Zt(t, e, i, s) {
    ...
    const h = e.pointStyle,
      ...
      d = e.radius;
    let u = (c || 0) * Mt;
    if (h && "object" == typeof h && ((n = h.toString()), "[object HTMLImageElement]" === n || "[object HTMLCanvasElement]" === n))
      return t.save(), t.translate(i, s), t.rotate(u), t.drawImage(h, -h.width / 2, -h.height / 2, h.width, h.height), void t.restore();
    if (!(isNaN(d) || d <= 0)) {
  ...
  function se(t, e, i, s, n, o = {}) {
    ...
    for (
      ...
      (h = a[l]),
        r && (o.strokeColor && (t.strokeStyle = o.strokeColor), $(o.strokeWidth) || (t.lineWidth = o.strokeWidth), t.strokeText(h, i, s, o.maxWidth)),
  ...
  function je(t, e, i, s) {
    ...
    for (n = 0, o = t.length; n < o; ++n)
      if (
        ((a = t[n]),
        void 0 !== a &&
          (void 0 !== e && "function" == typeof a && ((a = a(e)), (r = !1)), void 0 !== i && Y(a) && ((a = a[i % a.length]), (r = !1)), void 0 !== a))
      )
    ...
    return new Proxy(o, {
      ...
      get: (i, s) =>
        ci(i, s, () =>
          (function (t, e, i, s) {
            let n;
            for (const o of e) if (((n = mi(li(o, t), i)), ct(n))) return hi(t, n) ? gi(i, s, t, n) : n;
          })(s, e, t, i)
        ),
  ...
  function ki(t, e, i, s, n) {
    let o, a, r, l;
    if ((e.spanGaps && (t = t.filter((t) => !t.skip)), "monotone" === e.cubicInterpolationMode)) wi(t, n);
    else {
      ...
      (function (t, e) {
        ...
        for (i = 0, s = t.length; i < s; ++i)
          (a = o),
            ...
            o &&
              ((n = t[i]),
              a && ((n.cp1x = Mi(n.cp1x, e.left, e.right)), (n.cp1y = Mi(n.cp1y, e.top, e.bottom))),
              r && ((n.cp2x = Mi(n.cp2x, e.left, e.right)), (n.cp2y = Mi(n.cp2y, e.top, e.bottom))));
      })(t, i);
  }
  const Si = (t) => 0 === t || 1 === t,
    ...
    Ci = {
      ...
      easeInOutExpo: (t) => (Si(t) ? t : t < 0.5 ? 0.5 * Math.pow(2, 10 * (2 * t - 1)) : 0.5 * (2 - Math.pow(2, -10 * (2 * t - 1)))),
      ...
      easeInOutElastic(t) {
        const e = 0.1125;
        return Si(t) ? t : t < 0.5 ? 0.5 * Pi(2 * t, e, 0.45) : 0.5 + 0.5 * Di(2 * t - 1, e, 0.45);
      },
      easeInBack(t) {
        const e = 1.70158;
        return t * t * ((e + 1) * t - e);
      ...
      easeInOutBounce: (t) => (t < 0.5 ? 0.5 * Ci.easeInBounce(2 * t) : 0.5 * Ci.easeOutBounce(2 * t - 1) + 0.5),
    };
  function Oi(t, e, i, s) {
    return {
      x: t.x + i * (e.x - t.x),
  ...
  function Qi(t, e, i) {
    const s = t.canvas,
      n = new MutationObserver((t) => {
        let e = !1;
        for (const i of t) (e = e || Ji(i.addedNodes, s)), (e = e && !Ji(i.removedNodes, s));
        e && i();
      });
    return (
      n.observe(document, {
  ...
  function ts(t, e, i) {
    const s = t.canvas,
      n = new MutationObserver((t) => {
        let e = !1;
        for (const i of t) (e = e || Ji(i.removedNodes, s)), (e = e && !Ji(i.addedNodes, s));
        e && i();
      });
    return (
      n.observe(document, {
  ...
  class us {
    ...
    tick(t) {
      ...
      e < 0
        ? (this._target[s] = n)
        : ((r = (e / i) % 2), (r = o && r > 1 ? 2 - r : r), (r = this._easing(Math.min(1, Math.max(0, r)))), (this._target[s] = this._fn(n, a, r)));
    }
    wait() {
  ...
  class gs {
    ...
    _createAnimations(t, e) {
      ...
      for (r = o.length - 1; r >= 0; --r) {
        ...
        d && d.duration ? ((n[l] = c = new us(d, t, l, h)), s.push(c)) : (t[l] = h);
      }
      return s;
    }
    update(t, e) {
  ...
  function vs(t, e) {
    ...
    for (let t = 0; t < d; ++t) {
      const i = e[t],
        { [l]: o, [h]: d } = i;
      (u = (i._stacks || (i._stacks = {}))[h] = _s(n, c, o)), (u[r] = d), (u._top = ys(u, a, !0, s.type)), (u._bottom = ys(u, a, !1, s.type));
    }
  }
  function ws(t, e) {
    const i = t.scales;
    ...
    _update(t) {
      ...
      this.update(t || "default"),
        (e._clip = (function (t) {
          let e, i, s, n;
          return (
            U(t) ? ((e = t.top), (i = t.right), (s = t.bottom), (n = t.left)) : (e = i = s = n = t),
            {
              top: e,
              right: i,
              bottom: s,
  ...
  function As(t, e) {
    ...
    if (o > 0) {
      ...
      for (Ts(e, l, h, $(s) ? 0 : a - s, a), t = 0, i = o - 1; t < i; t++) Ts(e, l, h, n[t], n[t + 1]);
  ...
  function Es(t, e, i) {
    ...
    if (
      !(
        i &&
        ((l = 1 === s ? Math.max(h - o, a - h) : 0 === e ? (t.getPixelForTick(1) - h) / 2 : (h - t.getPixelForTick(n - 1)) / 2),
        (h += n < e ? l : -l),
        h < o - r || h > a + r)
      )
    )
  ...
  class Bs extends Ds {
    ...
    update(t, e, i) {
      ...
      this._convertTicksToLabels(r ? Rs(this.ticks, a) : this.ticks),
        ...
        o.display && (o.autoSkip || "auto" === o.source) && ((this.ticks = As(this, this.ticks)), (this._labelSizes = null)),
    ...
    fit() {
      ...
      if (o) {
        ...
        if (
          (a ? ((t.width = this.maxWidth), (t.height = Is(n) + o)) : ((t.height = this.maxHeight), (t.width = Is(n) + o)),
    ...
    _getLabelSizes() {
      ...
      if (!t) {
        ...
        let i = this.ticks;
        e < i.length && (i = Rs(i, e)), (this._labelSizes = t = this._computeLabelSizes(i, i.length));
      }
      return t;
    }
    ...
    drawBorder() {
      ...
      let r, l, h, c;
      this.isHorizontal()
        ? ((r = Kt(t, this.left, n) - n / 2), (l = Kt(t, this.right, o) + o / 2), (h = c = a))
        : ((h = Kt(t, this.top, n) - n / 2), (c = Kt(t, this.bottom, o) + o / 2), (r = l = a)),
        e.save(),
    ...
    drawLabels(t) {
      ...
      for (n = 0, o = s.length; n < o; ++n) {
        const t = s[n],
          i = t.font,
          o = t.label;
        t.backdrop && ((e.fillStyle = t.backdrop.color), e.fillRect(t.backdrop.left, t.backdrop.top, t.backdrop.width, t.backdrop.height)),
  ...
  function Ys(t, e) {
    return "x" === t || "y" === t
      ? t
      : e.axis || ("top" === (i = e.position) || "bottom" === i ? "x" : "left" === i || "right" === i ? "y" : void 0) || t.charAt(0).toLowerCase();
    var i;
  }
  function Us(t) {
  ...
  class dn {
    constructor(t, e) {
      ...
      (this.id = j()),
        ...
        (ln[this.id] = this),
        l && h
          ? (a.listen(this, "complete", on), a.listen(this, "progress", an), this._initialize(), this.attached && this.update())
    ...
    destroy() {
      ...
      this._stop(),
        ...
        t && (this.unbindEvents(), Gt(t, e), this.platform.releaseContext(e), (this.canvas = null), (this.ctx = null)),
    ...
    updateHoverStyle(t, e, i) {
      ...
      let n, o, a, r;
      for (
        "dataset" === e && ((n = this.getDatasetMeta(t[0].datasetIndex)), n.controller["_" + s + "DatasetHoverStyle"]()), a = 0, r = t.length;
        a < r;
        ++a
      ) {
        o = t[a];
  ...
  function vn(t, e, i, s) {
    ...
    "middle" === n &&
      i &&
      ((t.enableBorderRadius = !0), (i._top || 0) === s ? (n = h) : (i._bottom || 0) === s ? (n = c) : ((o[wn(c, a, r, l)] = !0), (n = h))),
      (o[wn(n, a, r, l)] = !0),
      (t.borderSkipped = o);
  }
  function wn(t, e, i, s) {
          ...
          l =
            "flex" === s.barThickness
              ...
              : (function (t, e, i, s) {
                  ...
                  let o, a;
                  return (
                    $(n) ? ((o = e.min * i.categoryPercentage), (a = i.barPercentage)) : ((o = n * s), (a = 1)),
                    {
                      chunk: o / s,
                      ratio: a,
    ...
    updateElements(t, e, i, s) {
      ...
      for (let r = e; r < e + i; r++) {
        ...
        (l.skip = isNaN(u) || isNaN(f)),
          h && ((l.options = this.resolveDataElementOptions(r, e.active ? "active" : s)), n && (l.options.radius = 0)),
  ...
  class Dn extends Ps {
    ...
    _circumference(t, e) {
      ...
      return (e && i.animation.animateRotate) || !this.chart.getDataVisibility(t) || null === s._parsed[t] || s.data[t].hidden
        ? 0
  ...
  function En(t, e, i) {
    ...
    t.beginPath(),
      t.arc(o, a, r, s - h, i + h),
      l > n ? ((h = n / l), t.arc(o, a, l, i + h, s - h, !0)) : t.arc(o, a, n, i + kt, s - kt),
      t.closePath(),
      t.clip();
  }
  function In(t, e, i, s) {
  ...
  function Bn(t, e, i, s, n) {
    ...
    a &&
      (l ? ((t.lineWidth = 2 * a), (t.lineJoin = r || "round")) : ((t.lineWidth = a), (t.lineJoin = r || "bevel")),
      e.fullCircles &&
        (function (t, e, i) {
  ...
  class Vn extends Ds {
    ...
    draw(t) {
      ...
      if (s) {
        ...
        t.translate(Math.cos(e) * o, Math.sin(e) * o), this.circumference >= _t && (o = s);
      }
  ...
  class qn extends Ds {
    ...
    draw(t, e, i, s) {
      ...
      (this.points || []).length && n.borderWidth && (t.save(), Xn(t, this, i, s), t.restore()),
  ...
  class Gn extends Ds {
    ...
    draw(t, e) {
      ...
      this.skip ||
        ...
        ((t.strokeStyle = i.borderColor), (t.lineWidth = i.borderWidth), (t.fillStyle = i.backgroundColor), Zt(t, i, this.x, this.y));
    }
    getRange() {
      const t = this.options || {};
  ...
  class so extends Ds {
    ...
    draw(t) {
      ...
      var r;
      t.save(),
        (o.w === n.w && o.h === n.h) || (t.beginPath(), a(t, io(o, e, n)), t.clip(), a(t, io(n, -e, o)), (t.fillStyle = i), t.fill("evenodd")),
        t.beginPath(),
        a(t, io(n, e)),
        (t.fillStyle = s),
        t.fill(),
            ...
            u = (function (t, e, i, s, n) {
              ...
              for (a[l++] = t[p], c = 0; c < o - 2; c++) {
                ...
                const b = Math.floor(c * r) + 1 + e,
                  ...
                  { x: y, y: v } = t[p];
                for (u = f = -1, s = b; s < _; s++)
                  (f = 0.5 * Math.abs((y - n) * (t[s].y - v) - (y - t[s].x) * (o - v))), f > u && ((u = f), (d = t[s]), (g = s));
                (a[l++] = d), (p = g);
              }
              return (a[l++] = t[h]), a;
            })(l, c, d, s, i);
  ...
  function co(t) {
    return (t.scale || {}).getPointPositionForValue
      ? (function (t) {
          ...
          let l, h, c;
          if (((c = "start" === i ? a : "end" === i ? r : U(i) ? i.value : e.getBaseValue()), s.grid.circular))
            return (
  ...
  class Do extends Ds {
    ...
    adjustHitBoxes() {
      ...
      if (this.isHorizontal()) {
        ...
        for (const l of e)
          o !== l.row && ((o = l.row), (r = n(i, this.left + s, this.right - this.lineWidths[o]))),
            (l.top += this.top + t + s),
        ...
        for (const l of e)
          l.col !== o && ((o = l.col), (r = n(i, this.top + t + s, this.bottom - this.columnSizes[o].height))),
            (l.top = r),
            (l.left += this.left + s),
    ...
    _draw() {
      const { options: t, columnSizes: e, lineWidths: i, ctx: s } = this,
        ...
        g = f / 2;
      let p;
      this.drawTitle(), (s.textAlign = h.textAlign("left")), (s.textBaseline = "middle"), (s.lineWidth = 0.5), (s.font = c.string);
      ...
      this.legendItems.forEach((w, M) => {
        ...
        h.setWidth(this.width),
          _
            ? M > 0 && D + P + u > this.right && ((C = p.y += v), p.line++, (D = p.x = n(a, this.left + u, this.right - i[p.line])))
            : M > 0 &&
              C + v > this.bottom &&
              ((D = p.x = D + e[p.line].width + u), p.line++, (C = p.y = n(a, this.top + y + u, this.bottom - e[p.line].height)));
        !(function (t, e, i) {
    ...
    _getLegendItemAt(t, e) {
      ...
      if (Yt(t, this.left, this.right) && Yt(e, this.top, this.bottom))
        for (n = this.legendHitBoxes, i = 0; i < n.length; ++i)
          if (((s = n[i]), Yt(t, s.left, s.left + s.width) && Yt(e, s.top, s.top + s.height))) return this.legendItems[i];
      return null;
    }
    handleEvent(t) {
      ...
      if ("mousemove" === t.type) {
        ...
        o && !a && J(e.onLeave, [t, o, this], this), (this._hoveredItem = i), i && !a && J(e.onHover, [t, i, this], this);
    ...
    _drawArgs(t) {
      ...
      return (
        this.isHorizontal()
          ...
          : ("left" === a.position ? ((h = i + t), (c = n(r, s, e)), (d = -0.5 * _t)) : ((h = o - t), (c = n(r, e, s)), (d = 0.5 * _t)), (l = s - e)),
        {
          titleX: h,
          titleY: c,
          maxWidth: l,
  ...
  class $o extends Ds {
      ...
      return (
        Q(t, (t) => {
          const e = {
            ...
            n = jo(i, t);
          Eo(e.before, Io(n.beforeLabel.call(this, t))), Eo(e.lines, n.label.call(this, t)), Eo(e.after, Io(n.afterLabel.call(this, t))), s.push(e);
        }),
        s
      );
    }
    ...
    getCaretPosition(t, e, i) {
      ...
      return (
        "center" === n
          ? ((_ = u + g / 2),
            "left" === s ? ((p = d), (m = p - o), (b = _ + o), (y = _ - o)) : ((p = d + f), (m = p + o), (b = _ - o), (y = _ + o)),
            (x = p))
          : ((m = "left" === s ? d + Math.max(r, h) + o : "right" === s ? d + f - Math.max(l, c) - o : this.caretX),
            "top" === n ? ((b = u), (_ = b - o), (p = m - o), (x = m + o)) : ((b = u + g), (_ = b + o), (p = m + o), (x = m - o)),
            (y = b)),
        {
          x1: p,
          x2: m,
      ...
      for (
        ...
        for (
          m = s[_],
            ...
            Q(m.before, g),
            b = m.lines,
            a && b.length && (this._drawColorBox(e, t, _, f, i), (d = Math.max(c.lineHeight, r))),
            y = 0,
            w = b.length;
          y < w;
          ++y
  ...
  class qo extends Bs {
    ...
    parse(t, e) {
      ...
      return ((t, e) =>
        null === t ? null : jt(Math.round(t), 0, e))((e = isFinite(e) && i[e] === t ? e : Xo(i, t, K(e, t), this._addedLabels)), i.length - 1);
    }
    determineDataLimits() {
      ...
      return (
        s
          ? ((e = Math.ceil(this.max / s) - Math.floor(this.min / s) + 1),
            e > 1e3 &&
              (console.warn(`scales.${this.id}.ticks.stepSize: ${s} would result generating up to ${e} ticks. Limiting to 1000.`), (e = 1e3)))
      ...
      const s = (function (t, e) {
        ...
        (M = Math.ceil(p / k) - Math.floor(g / k)),
          ...
          m && x && n && Rt((a - o) / n, k / 1e3)
            ? ((M = Math.round(Math.min((a - o) / k, h))), (k = (a - o) / M), (v = o), (w = a))
            : b
            ? ((v = m ? o : v), (w = x ? a : w), (M = l - 1), (k = (w - v) / M))
            : ((M = (w - v) / k), (M = Lt(M, Math.round(M), k / 1e3) ? Math.round(M) : Math.ceil(M)));
  ...
  class Qo extends Bs {
    ...
    buildTicks() {
      ...
      return (
        ...
        t.reverse ? (e.reverse(), (this.start = this.max), (this.end = this.min)) : ((this.start = this.min), (this.end = this.max)),
        e
      );
    }
    getLabelForValue(t) {
  ...
  function ua(t, e) {
    ...
    return (
      ...
      null === a ? null : (n && (a = "week" !== n || (!Tt(o) && !0 !== o) ? i.startOf(a, n) : i.startOf(a, "isoWeek", o)), +a)
    );
  }
  function fa(t, e, i, s) {
    const n = ca.length;
  ...
  class ma extends Bs {
    ...
    determineDataLimits() {
      ...
      (o && a) || (r(this._getLabelBounds()), ("ticks" === t.bounds && "labels" === t.ticks.source) || r(this.getMinMax(!1))),
      ...
      return (
          ...
          (i.autoSkip
            ...
            : (function (t, e, i, s, n) {
                for (let o = ca.length - 1; o >= ca.indexOf(i); o--) {
                  const i = ca[o];
                  if (ha[i].common && t._adapter.diff(n, s, i) >= e - 1) return i;
                }
        ...
        (this._majorUnit =
          i.major.enabled && "year" !== this._unit
            ? (function (t) {
                for (let e = ca.indexOf(t) + 1, i = ca.length; e < i; ++e) if (ha[ca[e]].common) return ca[e];
              })(this._unit)
            : void 0),
        this.initOffsets(s),
        t.reverse && o.reverse(),
    ...
    _generate() {
      ...
      let c,
        d,
        u = e;
      if ((l && (u = +t.startOf(u, "isoWeek", r)), (u = +t.startOf(u, l ? "day" : o)), t.diff(i, e, o) > 1e5 * a))
  ...
  function xa(t, e, i) {
    let s,
      ...
      l = t.length - 1;
    i
      ? (e >= t[r].pos && e <= t[l].pos && ({ lo: r, hi: l } = re(t, "pos", e)), ({ pos: s, time: o } = t[r]), ({ pos: n, time: a } = t[l]))
      : (e >= t[r].time && e <= t[l].time && ({ lo: r, hi: l } = re(t, "time", e)), ({ time: s, pos: o } = t[r]), ({ time: n, pos: a } = t[l]));
    const h = n - s;
